<script type='text/javascript'>
	...
	function taskFormValidator() {
		...
		var myInputs = new Array();
					...
					i++;
					myInputs[i] = document.getElementById("Comment");
					i++;
          ...
          <fieldset>
            <legend>Task Outputs</legend>
                            		...
                            		<div class="div_texbox">
                              		<input name="Approval" type="text" class="textbox" id="Approval" value="${Approval}" />
                            		</div>
                            		...
                            		<label for="name">Comment</label>
                            		<div class="div_texbox">
                              		<input name="Comment" type="text" class="textbox" id="Comment" value="${Comment}" />
                            		</div>
